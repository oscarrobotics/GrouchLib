...
public class CANTalon implements GeniusMC {
    ...
    @Override
    public void setNeutralMode(frc.team832.lib.motorcontrol.NeutralMode mode) {
    ...
    public void setAllowableClosedLoopError(double error) {
        ...
        _talon.configAllowableClosedloopError(0, (int)error);
    }
    ...
    @Override
    public void setMotionMagicArbFF(double position, double arbFF) {
        _ctrlMode = ControlMode.MotionMagic;
